def two_obj_nadir(Cbat,del_t,SOC_1,TT1,TT2,TT3,Nv,utopia_sol1,utopia_sol3,weights,WEPV,num_stab,utopia_I_sol2, utopia_SOC_avg_sol2):
    ...
    all_utopia_pnts = [utopia_sol1,utopia_sol3]#,utopia_sol3]
    ...
    utopia_SOC_avg = [utopia_SOC_avg_sol1, utopia_SOC_avg_sol3]#,utopia_SOC_avg_sol3]
    ...
    return nadir_obj1,nadir_obj3#,nadir_obj3 nadir_obj1
